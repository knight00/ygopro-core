...
static const struct luaL_Reg cardlib[] = {
	...
	{ "HasAttackedDirectly", scriptlib::Card_HasAttackedDirectly },
	...
	{ "HasCardAsTarget", scriptlib::Card_HasCardAsTarget },
	{ "CancelCardTarget", scriptlib::card_cancel_card_target },
	{ "GetAbsoluteTargetGroup", scriptlib::Card_GetAbsoluteTargetGroup },
	{ "GetAbsoluteTargetGroupCount", scriptlib::Card_GetAbsoluteTargetGroupCount },
	...
	{ "IsRelatedToEffect", scriptlib::Card_IsRelatedToEffect },
	{ "IsRelatedToChain", scriptlib::Card_IsRelatedToChain },
	{ "IsRelatedToCard", scriptlib::Card_IsRelatedToCard },
	{ "IsRelatedToBattle", scriptlib::Card_IsRelatedToBattle },
	...
	{ "CanBeDestroyed", scriptlib::Card_CanBeDestroyed },
	{ "CanBeNormalSummonSet", scriptlib::Card_CanBeNormalSummonSet },
	{ "CanBeFusionSummoned", scriptlib::Card_CanBeFusionSummoned },
	{ "IsSpecialSummonable", scriptlib::card_is_special_summonable }, // Would be translated to CanBeSpecialSummoned, but see line 186
	{ "CanBeSynchroSummoned", scriptlib::Card_CanBeSynchroSummoned },
	{ "CanBeXyzSummoned", scriptlib::Card_CanBeXyzSummoned },
	{ "CanBeLinkSummoned", scriptlib::Card_CanBeLinkSummoned },
	{ "CanBeNormalSummoned", scriptlib::Card_CanBeNormalSummoned },
	...
	{ "CanBeTributed", scriptlib::Card_CanBeTributed },
	{ "CanBeTributedByEffect", scriptlib::Card_CanBeTributedByEffect },
	{ "CanBeDiscarded", scriptlib::Card_CanBeDiscarded },
	...
	{ "CanChangeController", scriptlib::Card_CanChangeController },
	{ "CanControllerBeChanged", scriptlib::Card_CanControllerBeChanged },
	...
	{ "CanChangePosition", scriptlib::Card_CanChangePosition },
	{ "CanBeFlippedSet", scriptlib::Card_CanBeFlippedSet },
	{ "CanHoldCounter", scriptlib::Card_CanHoldCounter },
	{ "CanRemoveCounter", scriptlib::Card_CanRemoveCounter },
	{ "CanBeFusionMaterial", scriptlib::Card_CanBeFusionMaterial },
	{ "CanBeSynchroMaterial", scriptlib::Card_CanBeSynchroMaterial },
	{ "CanBeRitualMaterial", scriptlib::Card_CanBeRitualMaterial },
	{ "CanBeXyzMaterial", scriptlib::Card_CanBeXyzMaterial },
	{ "CanBeLinkMaterial", scriptlib::Card_CanBeLinkMaterial },
	{ "CanBeMaterial", scriptlib::Card_CanBeMaterial },
	...
	{ "CanBeTargetedByEffect", scriptlib::Card_CanBeTargetedByEffect },
	{ "CanBeTargetedByAttack", scriptlib::Card_CanBeTargetedByAttack },
...
static const struct luaL_Reg effectlib[] = {
	...
	{ "HasProperty", scriptlib::Effect_HasProperty },
	{ "HasCategory", scriptlib::Effect_HasCategory },
	{ "HasType", scriptlib::Effect_HasType },
	{ "CanBeActivated", scriptlib::Effect_CanBeActivated },
...
static const struct luaL_Reg duellib[] = {
	...
	{ "CanPlayerRemoveCounter", scriptlib::Duel_CanPlayerRemoveCounter },
	...
	{ "SetChainLimitUntilChainEnd", scriptlib::Duel_SetChainLimitUntilChainEnd },
	...
	{ "IsExistingMatchingCard", scriptlib::Duel_IsExistingMatchingCard },
	...
	{ "CanPlayerDraw", scriptlib::Duel_CanPlayerDraw },
	{ "CanPlayerDiscardDeck", scriptlib::Duel_CanPlayerDiscardDeck },
	{ "CanPlayerDiscardDeckAsCost", scriptlib::Duel_CanPlayerDiscardDeckAsCost },
	{ "CanPlayerSummon", scriptlib::Duel_CanPlayerSummon },
	{ "CanPlayerSetMonster", scriptlib::duel_can_player_set_monster },
	{ "CanPlayerSetSpellTrap", scriptlib::duel_can_player_set_spell_trap },
	{ "CanPlayerSpecialSummon", scriptlib::Duel_CanPlayerSpecialSummon },
	{ "CanPlayerFlipSummon", scriptlib::Duel_CanPlayerFlipSummon },
	{ "CanPlayerSpecialSummonMonster", scriptlib::Duel_CanPlayerSpecialSummonMonster },
	{ "CanPlayerSpecialSummonCount", scriptlib::Duel_CanPlayerSpecialSummonCount },
	{ "CanPlayerTribute", scriptlib::Duel_CanPlayerTribute },
	{ "CanPlayerBanish", scriptlib::Duel_CanPlayerBanish },
	{ "CanPlayerAddToHand", scriptlib::Duel_CanPlayerAddToHand },
	{ "CanPlayerSendToGrave", scriptlib::Duel_CanPlayerSendToGrave },
	{ "CanPlayerSendToDeck", scriptlib::Duel_CanPlayerSendToDeck },
	{ "CanPlayerSummonAdditionally", scriptlib::Duel_CanPlayerSummonAdditionally },
...
int32 interpreter::call_function(int32 f, uint32 param_count, int32 ret_count) {
	if (!f) {
		...
		sprintf(pduel->strbuffer, "%s", "\"CallFunction\": attempt to call a null function.");
		pduel->handle_message(pduel->handle_message_payload, pduel->strbuffer, OCG_LOG_TYPE_ERROR);
		params.clear();
		return OPERATION_FAIL;
	}
...
int32 interpreter::call_code_function(uint32 code, char* f, uint32 param_count, int32 ret_count) {
	...
	if (!lua_isfunction(current_state, -1)) {
		interpreter::print_stacktrace(current_state);
		sprintf(pduel->strbuffer, "%s", "\"CallCodeFunction\": attempt to call an error function");
		pduel->handle_message(pduel->handle_message_payload, pduel->strbuffer, OCG_LOG_TYPE_ERROR);
		lua_pop(current_state, 2);
		params.clear();
		return OPERATION_FAIL;
...
int32 interpreter::call_coroutine(int32 f, uint32 param_count, uint32 * yield_value, uint16 step) {
	*yield_value = 0;
	if (!f) {
		interpreter::print_stacktrace(current_state);
		sprintf(pduel->strbuffer, "%s", "\"CallCoroutine\": attempt to call a null function");
		pduel->handle_message(pduel->handle_message_payload, pduel->strbuffer, OCG_LOG_TYPE_ERROR);
		params.clear();
		return OPERATION_FAIL;
	}
	if (param_count != params.size()) {
		interpreter::print_stacktrace(current_state);
		sprintf(pduel->strbuffer, "%s", "\"CallCoroutine\": incorrect parameter count");
		pduel->handle_message(pduel->handle_message_payload, pduel->strbuffer, OCG_LOG_TYPE_ERROR);
		params.clear();
		return OPERATION_FAIL;
	}
	...
	if (it == coroutines.end()) {
		...
		if(step == 0) {
			interpreter::print_stacktrace(current_state);
			sprintf(pduel->strbuffer, "%s", "recursive event trigger detected.");
			pduel->handle_message(pduel->handle_message_payload, pduel->strbuffer, OCG_LOG_TYPE_ERROR);
			params.clear();
			call_depth--;
			if(call_depth == 0) {
