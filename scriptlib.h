...
public:
	...
	static int32 card_get_controller(lua_State *L);
	static int32 card_get_previous_controller(lua_State *L);
	...
	static int32 card_has_attacked_directly(lua_State *L);
	...
	static int32 card_has_card_as_target(lua_State *L);
	static int32 card_cancel_card_target(lua_State *L);
	static int32 card_get_absolute_target_group(lua_State *L);
	static int32 card_get_absolute_target_group_count(lua_State *L);
	...
	static int32 card_has_effect(lua_State *L);
	...
	static int32 card_is_related_to_effect(lua_State *L);
	static int32 card_is_related_to_chain(lua_State *L);
	static int32 card_is_related_to_card(lua_State *L);
	static int32 card_is_related_to_battle(lua_State *L);
	...
	static int32 card_can_be_destroyed(lua_State *L);
	static int32 card_can_be_normal_summon_set(lua_State *L);
	static int32 card_can_be_fusion_summoned(lua_State* L);
	static int32 card_can_set_in_mzone(lua_State *L);
	static int32 card_can_set_in_szone(lua_State *L);
	...
	static int32 card_can_send_to_hand(lua_State *L);
	static int32 card_can_send_to_grave(lua_State *L);
	static int32 card_can_send_to_deck(lua_State *L);
	static int32 card_can_send_to_extra(lua_State *L);
	static int32 card_can_be_banished(lua_State *L);
	static int32 card_can_send_to_hand_as_cost(lua_State *L);
	static int32 card_can_send_to_grave_as_cost(lua_State *L);
	static int32 card_can_send_to_deck_as_cost(lua_State *L);
	static int32 card_can_send_to_extra_as_cost(lua_State *L);
	static int32 card_can_send_to_deck_or_extra_as_cost(lua_State *L);
	static int32 card_can_be_banished_as_cost(lua_State *L);
	static int32 card_can_be_tributed(lua_State *L);
	static int32 card_can_be_tributed_by_effect(lua_State *L);
	static int32 card_can_be_discarded(lua_State *L);
	...
	static int32 card_is_attack_position(lua_State *L);
	static int32 card_is_facedown(lua_State *L);
	static int32 card_is_defense_position(lua_State *L);
	static int32 card_is_position(lua_State *L);
	static int32 card_is_pre_position(lua_State *L);
	static int32 card_is_controller(lua_State *L);
	...
	static int32 card_can_change_controller(lua_State *L);
	static int32 card_can_controller_be_changed(lua_State *L);
	...
	static int32 card_can_change_position(lua_State *L);
	static int32 card_can_be_flipped_set(lua_State *L);
	static int32 card_can_hold_counter(lua_State *L);
	static int32 card_can_remove_counter(lua_State *L);
	static int32 card_can_be_fusion_material(lua_State *L);
	static int32 card_can_be_synchro_material(lua_State *L);
	static int32 card_can_be_ritual_material(lua_State *L);
	static int32 card_can_be_xyz_material(lua_State *L);
	static int32 card_can_be_link_material(lua_State *L);
	static int32 card_can_be_material(lua_State *L);
	...
	static int32 card_can_be_targeted_by_effect(lua_State *L);
	static int32 card_can_be_targeted_by_attack(lua_State *L);
	...
	static int32 card_set_special_summon_once(lua_State *L);
	...
	static int32 effect_has_property(lua_State *L);
	static int32 effect_has_category(lua_State *L);
	static int32 effect_has_type(lua_State *L);
	static int32 effect_can_be_activated(lua_State *L);
	...
	static int32 group_at(lua_State *L);
	...
	static int32 group_exists(lua_State *L);
	...
	static int32 group_contains(lua_State *L);
	...
	static int32 duel_banish(lua_State *L);
	static int32 duel_send_to_grave(lua_State *L);
	...
	static int32 duel_set_in_mzone(lua_State *L);
	static int32 duel_set_in_szone(lua_State *L);
	...
	static int32 duel_send_to_hand(lua_State *L);
	static int32 duel_send_to_deck(lua_State *L);
	static int32 duel_send_to_extra_faceup(lua_State *L);
	static int32 duel_send_to(lua_State *L);
	static int32 duel_banish_cards(lua_State *L);
	static int32 duel_get_operated_group(lua_State *L);
	static int32 duel_can_player_add_counter(lua_State *L);
	static int32 duel_remove_counter(lua_State *L);
	static int32 duel_can_player_remove_counter(lua_State *L);
	static int32 duel_get_counter(lua_State *L);
	static int32 duel_change_form(lua_State *L);
	static int32 duel_tribute(lua_State *L);
	...
	static int32 duel_set_chain_limit_until_chain_end(lua_State *L);
	static int32 duel_get_chain_material(lua_State *L);
	static int32 duel_confirm_top_deck(lua_State *L);
	static int32 duel_confirm_top_extra(lua_State *L);
	static int32 duel_confirm_cards(lua_State *L);
	static int32 duel_sort_top_deck(lua_State *L);
	...
	static int32 duel_recover_damage_complete(lua_State *L);
	...
	static int32 duel_mill(lua_State *L);
	...
	static int32 duel_get_location_count_for_extra(lua_State *L);
	...
	static int32 duel_get_top_deck_group(lua_State *L);
	static int32 duel_get_top_extra_group(lua_State *L);
	...
	static int32 duel_exists_matching_card(lua_State *L);
	static int32 duel_select_matching_cards(lua_State *L);
	static int32 duel_get_effect_tribute_group(lua_State *L);
	static int32 duel_get_effect_tribute_group_count(lua_State *L);
	static int32 duel_check_effect_tribute_group(lua_State *L);
	static int32 duel_select_effect_tribute_group(lua_State *L);
	static int32 duel_check_effect_tribute_group_additional(lua_State *L);
	static int32 duel_select_effect_tribute_group_additional(lua_State *L);
	static int32 duel_get_summon_tribute_group(lua_State *L);
	static int32 duel_get_summon_tribute_count(lua_State *L);
	...
	static int32 duel_exists_matching_target(lua_State *L);
	...
	static int32 duel_tribute_ritual_material(lua_State *L);
	...
	static int32 duel_can_player_draw(lua_State *L);
	static int32 duel_can_player_mill(lua_State *L);
	static int32 duel_can_player_mill_as_cost(lua_State *L);
	static int32 duel_can_player_summon(lua_State *L);
	static int32 duel_can_player_set_monster(lua_State *L);
	static int32 duel_can_player_set_spell_trap(lua_State *L);
	static int32 duel_can_player_special_summon(lua_State *L);
	static int32 duel_can_player_flip_summon(lua_State *L);
	static int32 duel_can_player_special_summon_monster(lua_State *L);
	static int32 duel_can_player_special_summon_count(lua_State *L);
	static int32 duel_can_player_tribute(lua_State *L);
	static int32 duel_can_player_banish(lua_State *L);
	static int32 duel_can_player_add_to_hand(lua_State *L);
	static int32 duel_can_player_send_to_grave(lua_State *L);
	static int32 duel_can_player_send_to_deck(lua_State *L);
	static int32 duel_can_player_summon_additionally(lua_State *L);
	static int32 duel_is_chain_negatable(lua_State *L);
	static int32 duel_is_chain_disableable(lua_State *L);
	...
	static int32 duel_can_enter_battle_phase(lua_State *L);
