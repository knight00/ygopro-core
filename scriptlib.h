...
public:
	...
	static int32 Card_HasAttackedDirectly(lua_State *L);
	...
	static int32 Card_HasCardAsTarget(lua_State *L);
	static int32 card_cancel_card_target(lua_State *L);
	static int32 Card_GetAbsoluteTargetGroup(lua_State *L);
	static int32 Card_GetAbsoluteTargetGroupCount(lua_State *L);
	...
	static int32 Card_IsRelatedToEffect(lua_State *L);
	static int32 Card_IsRelatedToChain(lua_State *L);
	static int32 Card_IsRelatedToCard(lua_State *L);
	static int32 Card_IsRelatedToBattle(lua_State *L);
	...
	static int32 Card_CanBeDestroyed(lua_State *L);
	static int32 Card_CanBeNormalSummonSet(lua_State *L);
	static int32 Card_CanBeFusionSummoned(lua_State* L);
	...
	static int32 Card_CanBeSynchroSummoned(lua_State *L);
	static int32 Card_CanBeXyzSummoned(lua_State *L);
	static int32 Card_CanBeLinkSummoned(lua_State *L);
	static int32 Card_CanBeNormalSummoned(lua_State *L);
	...
	static int32 Card_CanBeTributed(lua_State *L);
	static int32 Card_CanBeTributedByEffect(lua_State *L);
	static int32 Card_CanBeDiscarded(lua_State *L);
	...
	static int32 Card_CanChangeController(lua_State *L);
	static int32 Card_CanControllerBeChanged(lua_State *L);
	...
	static int32 Card_CanChangePosition(lua_State *L);
	static int32 Card_CanBeFlippedSet(lua_State *L);
	static int32 Card_CanHoldCounter(lua_State *L);
	static int32 Card_CanRemoveCounter(lua_State *L);
	static int32 Card_CanBeFusionMaterial(lua_State *L);
	static int32 Card_CanBeSynchroMaterial(lua_State *L);
	static int32 Card_CanBeRitualMaterial(lua_State *L);
	static int32 Card_CanBeXyzMaterial(lua_State *L);
	static int32 Card_CanBeLinkMaterial(lua_State *L);
	static int32 Card_CanBeMaterial(lua_State *L);
	...
	static int32 Card_CanBeTargetedByEffect(lua_State *L);
	static int32 Card_CanBeTargetedByAttack(lua_State *L);
	...
	static int32 Effect_HasProperty(lua_State *L);
	static int32 Effect_HasCategory(lua_State *L);
	static int32 Effect_HasType(lua_State *L);
	static int32 Effect_CanBeActivated(lua_State *L);
	...
	static int32 Duel_CanPlayerRemoveCounter(lua_State *L);
	...
	static int32 Duel_SetChainLimitUntilChainEnd(lua_State *L);
	...
	static int32 Duel_IsExistingMatchingCard(lua_State *L);
	...
	static int32 Duel_CanPlayerDraw(lua_State *L);
	static int32 Duel_CanPlayerDiscardDeck(lua_State *L);
	static int32 Duel_CanPlayerDiscardDeckAsCost(lua_State *L);
	static int32 Duel_CanPlayerSummon(lua_State *L);
	static int32 duel_can_player_set_monster(lua_State *L);
	static int32 duel_can_player_set_spell_trap(lua_State *L);
	static int32 Duel_CanPlayerSpecialSummon(lua_State *L);
	static int32 Duel_CanPlayerFlipSummon(lua_State *L);
	static int32 Duel_CanPlayerSpecialSummonMonster(lua_State *L);
	static int32 Duel_CanPlayerSpecialSummonCount(lua_State *L);
	static int32 Duel_CanPlayerTribute(lua_State *L);
	static int32 Duel_CanPlayerBanish(lua_State *L);
	static int32 Duel_CanPlayerAddToHand(lua_State *L);
	static int32 Duel_CanPlayerSendToGrave(lua_State *L);
	static int32 Duel_CanPlayerSendToDeck(lua_State *L);
	static int32 Duel_CanPlayerSummonAdditionally(lua_State *L);
