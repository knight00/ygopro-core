...
#define DUEL_RELAY             0x8000
#define DUEL_RUSH              0x10000
#define DUEL_MODE_MR1          (DUEL_OBSOLETE_IGNITION | DUEL_1ST_TURN_DRAW | DUEL_1_FACEUP_FIELD)
#define DUEL_MODE_MR2          (DUEL_1ST_TURN_DRAW | DUEL_1_FACEUP_FIELD)
#define DUEL_MODE_MR3          (DUEL_PZONE | DUEL_SEPARATE_PZONE)
#define DUEL_MODE_MR4          (DUEL_PZONE | DUEL_EMZONE)
#define DUEL_MODE_MR5          (DUEL_MODE_MR4 | DUEL_FSX_MMZONE)
